...
import { FriendsType, UserList2 } from './UserList2';
import { AdressType } from './UserList2';
...
export type UserType = {
  ...
  name: string;
  age: number;
  address: AdressType; // пропиши типизацию
};

export type UsersObjectType = {
  myFriends: FriendsType[]; // пропиши типизацию
};
